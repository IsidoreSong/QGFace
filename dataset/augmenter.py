...
class Augmenter:
    def __init__(self, crop_augmentation_prob, photometric_augmentation_prob, low_res_augmentation_prob):
        ...
        self.random_resized_crop = transforms.RandomResizedCrop(size=(112, 112), scale=(0.2, 1.0), ratio=(0.75, 1.3333333333333333))
    ...
    def crop_augment(self, sample):
        ...
        i, j, h, w = self.random_resized_crop.get_params(sample, self.random_resized_crop.scale, self.random_resized_crop.ratio)
